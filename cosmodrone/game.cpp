...
void Cosmodrone::RunGame(Tachyon* tachyon) {
  // @temporary
  {
    ...
    sun.position = tVec3f(-100.f, 50.f * sinf(tachyon->running_time * 3.f), -200.f);
    ...
    sun2.position = tVec3f(100.f, 50.f * cosf(tachyon->running_time * 3.f), -200.f);
  ...
  // @temporary
  {
    ...
    moon.position = tVec3f(-300.f, 50.f * cosf(tachyon->running_time * 3.f), -200.f);
    ...
    moon2.position = tVec3f(300.f, 50.f * sinf(tachyon->running_time * 3.f), -200.f);
