...
namespace Cosmodrone {
  ...
  struct SolarRotatorLight {
    tObject rotator;
    uint32 light_index_1 = 0;
  ...
  struct State {
    ...
    float camera_blend_rate_factor = 0.f;
    ...
    std::vector<SolarRotatorLight> solar_rotator_lights;
