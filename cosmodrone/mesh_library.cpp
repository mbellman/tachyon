...
static void LoadGeneratedMeshes(Tachyon* tachyon, State& state) {
  ...
  load_mesh(solar_rotator_2_lights);
  ...
  load_mesh(fighter_left_wing_core);
  load_mesh(fighter_left_wing_turrets);
  ...
  generated_mesh_assets = {
    ...
    // building_1
    {
      .mesh_index = meshes.building_1_windows,
      .generated_from = meshes.building_1,
      .defaults = {
        .color = 0x0042,
    ...
    {
      .mesh_index = meshes.platform_core,
      .generated_from = meshes.platform,
      .defaults = {
        .color = tVec3f(0.1f),
    ...
    {
      .mesh_index = meshes.solar_rotator_2_lights,
      .generated_from = meshes.solar_rotator_2,
      .defaults = {
        .color = tVec4f(1.f, 0.1f, 0.1f, 1.f),
        .material = tVec4f(1.f, 0, 0, 0)
      }
    },
    ...
    // fighter_spawn
    {
      ...
      .defaults = {
        ...
        .material = tVec4f(1.f, 0, 0.2f, 0.5f)
      }
    },
    {
