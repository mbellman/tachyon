...
namespace astro {
  behavior OakTree {
    ...
    timeEvolve() {
      ...
      const tVec3f leaves_color = tVec3f(0.14f, 0.5f, 0.07f);
      ...
      tVec3f current_roots_color = tVec3f::lerp(roots_color, aged_wood_color, alpha);
      ...
      for_entities(state.oak_trees) {
        ...
        // Roots
        {
          ...
          roots.color = current_roots_color;
