...
static void AddDecorativeMeshes(Tachyon* tachyon, State& state) {
  ...
  meshes.rock_1        = MODEL_MESH_LOD_2("./astro/3d_models/rock_1.obj", "./astro/3d_models/rock_1_LoD.obj", 2000);
  meshes.rock_2        = MODEL_MESH("./astro/3d_models/rock_2.obj", 2000);
  meshes.rock_step     = MODEL_MESH("./astro/3d_models/rock_step.obj", 500);
  meshes.rock_stair    = MODEL_MESH("./astro/3d_models/rock_stair.obj", 1000);
  meshes.river_edge    = MODEL_MESH_LOD_2("./astro/3d_models/river_edge.obj", "./astro/3d_models/river_edge_LoD.obj", 5000);
  meshes.ground_1      = MODEL_MESH_LOD_2("./astro/3d_models/ground_1.obj", "./astro/3d_models/ground_1_LoD.obj", 5000);
  meshes.lookout_tower = MODEL_MESH("./astro/3d_models/decoratives/lookout_tower.obj", 50);
  ...
  mesh(meshes.rock_stair).shadow_cascade_ceiling = 1;
...
static void AddFaunaMeshes(Tachyon* tachyon, State& state) {
  ...
  meshes.swan_beak_skin = MODEL_MESH("./astro/3d_models/fauna/swan_beak_skin.obj", 50);
  ...
  mesh(meshes.tiny_bird_feet).shadow_cascade_ceiling = 0;
  ...
  mesh(meshes.swan_beak_skin).shadow_cascade_ceiling = 0;
}
...
static void AddSkinnedPlayerMeshes(Tachyon* tachyon, State& state) {
  ...
  tSkinnedMesh player_vambraces = Tachyon_LoadSkinnedMesh(
    "./astro/3d_models/characters/player_vambraces.skin",
    rest_pose
  );
  ...
  meshes.player_vambraces = Tachyon_AddSkinnedMesh(tachyon, player_vambraces);
...
void MeshLibrary::AddMeshes(Tachyon* tachyon, State& state) {
  ...
  // @todo factor
  {
    ...
    meshes.player_flask   = MODEL_MESH("./astro/3d_models/characters/player_flask.obj", 2);
  ...
  mesh(meshes.river_leaf).shadow_cascade_ceiling = 0;
