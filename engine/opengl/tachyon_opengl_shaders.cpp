...
static void StoreShaderUniforms(tOpenGLShaders& shaders) {
  ...
  store_shader_uniform(main_geometry, is_foliage);
  ...
  store_shader_uniform(skinned_mesh, model_surface);
  ...
  store_shader_uniform(point_lights, show_light_discs);
  ...
  store_shader_uniform(water_mesh, in_shadow_map_cascade_4);
  store_shader_uniform(water_mesh, light_matrix_cascade_1);
  store_shader_uniform(water_mesh, light_matrix_cascade_2);
  ...
  store_shader_uniform(post, dialogue_overlay_opacity);
