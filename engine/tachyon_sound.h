...
void Tachyon_FadeInSound(tSoundResource& resource, uint64 duration, const float volume = 1.f);
void Tachyon_FadeSoundTo(tSoundResource& resource, uint64 duration, const float volume = 1.f);
